    ...
    <div className="p-6">
      <div className="flex items-center gap-3 mb-6">
        <div className="w-12 h-12 rounded-full bg-red-100 flex items-center justify-center">
          <RiSettings5Line className="text-2xl text-[#BF1E2E]" />
        </div>

        <h1 className="text-xl font-bold text-[#BF1E2E]">Settings</h1>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
        ...
        >
          ...
          <h2 className="text-xl font-bold text-[#BF1E2E] mb-3">User Roles</h2>
        ...
        >
          ...
          <h2 className="text-xl font-bold text-[#BF1E2E] mb-3">Security</h2>
